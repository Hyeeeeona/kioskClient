...
public class OrderHistoryListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<OrderHistoryListViewItem> orderHistoryListViewItems = new ArrayList<OrderHistoryListViewItem>() ;
    ...
    @Override
    public int getCount() {
        return orderHistoryListViewItems.size() ;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.order_history_list_item, parent, false);
        }
    ...
    public Object getItem(int position) {
        return orderHistoryListViewItems.get(position) ;
    }
