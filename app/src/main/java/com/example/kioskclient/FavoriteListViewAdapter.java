...
public class FavoriteListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<FavoriteListViewItem> favoriteListViewItems = new ArrayList<FavoriteListViewItem>() ;
    ...
    @Override
    public int getCount() {
        return favoriteListViewItems.size() ;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.favorite_item_imageView) ;
        TextView storeNameTextView = (TextView) convertView.findViewById(R.id.favorite_item_store_name) ;
        TextView menuTextView = (TextView) convertView.findViewById(R.id.favorite_item_menu) ;
